...
<head>
    ...
    <title><?= isset($page_title) ? $page_title . ' - Supervisor Produksi' : 'Supervisor Produksi' ?> | Penjadwalan Produksi TMU</title>
    ...
    <div id="sidebar" class="sidebar fixed top-0 left-0 h-full bg-white shadow-lg z-50">
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                <a href="gantt_chart_estimasi.php" class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'gantt_chart_estimasi.php' ? 'active' : '' ?>">
            ...
            <div class="p-4 border-t border-gray-200">
                <div class="flex items-center space-x-3 mb-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs text-gray-500 truncate">Supervisor Produksi</p>
                    </div>
                </div>
        ...
        <div class="md:hidden bg-white shadow-sm border-b border-gray-200 p-4">
            <div class="flex items-center justify-between">
                ...
                <h1 class="font-semibold text-gray-900">
                    <?= isset($page_title) ? $page_title : 'Supervisor Produksi' ?>
                </h1>
                <div></div>
            </div>
        </div>
