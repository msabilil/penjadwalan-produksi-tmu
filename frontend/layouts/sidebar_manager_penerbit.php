...
<head>
    ...
    <title><?= isset($page_title) ? $page_title . ' - Manager Penerbit' : 'Manager Penerbit' ?> | Penjadwalan Produksi TMU</title>
...
<body class="bg-gray-50">
            ...
            <div class="p-4 border-t border-gray-200">
                <div class="flex items-center space-x-3 mb-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs text-gray-500 truncate">Manager Penerbit</p>
                    </div>
                </div>
        ...
        <div class="md:hidden bg-white shadow-sm border-b border-gray-200 p-4">
            <div class="flex items-center justify-between">
                ...
                <h1 class="font-semibold text-gray-900">
                    <?= isset($page_title) ? $page_title : 'Manager Penerbit' ?>
                </h1>
                <div></div>
            </div>
        </div>
    ...
    <script>
        ...
        window.swalSuccess = '<?= addslashes($swal_success) ?>';
        <?php endif; ?>

        <?php if (isset($swal_error)): ?>
        window.swalError = '<?= addslashes($swal_error) ?>';
        <?php endif; ?>
    </script>
</body>
</html>
