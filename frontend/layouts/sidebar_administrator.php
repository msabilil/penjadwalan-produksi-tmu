...
<head>
    ...
    <title><?= isset($page_title) ? $page_title . ' - Administrator' : 'Administrator' ?> | Penjadwalan Produksi TMU</title>
    ...
    <div id="sidebar" class="sidebar fixed top-0 left-0 h-full bg-white shadow-lg z-50">
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                <a href="data_user.php" class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'data_user.php' ? 'active' : '' ?>">
                    <i class="fas fa-users"></i>
                    <span>Data User</span>
                </a>
                
                <a href="data_desain.php" class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'data_desain.php' ? 'active' : '' ?>">
                    <i class="fas fa-palette"></i>
                    <span>Data Desain</span>
                </a>
                
                <a href="data_mesin.php" class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'data_mesin.php' ? 'active' : '' ?>">
        ...
        <div class="md:hidden bg-white shadow-sm border-b border-gray-200 p-4">
            <div class="flex items-center justify-between">
                ...
                <h1 class="font-semibold text-gray-900">
                    <?= isset($page_title) ? $page_title : 'Administrator' ?>
                </h1>
                <div></div>
            </div>
        </div>
