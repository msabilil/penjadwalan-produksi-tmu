    ...
    showSuccess(message) {
        if (typeof Swal !== 'undefined') {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Simple approach: just redirect to clean page
    ...
    showError(message) {
        if (typeof Swal !== 'undefined') {
            Swal.fire({
                ...
                // Keep user on the same page for error messages
                // No reload needed for errors
            });
        }
    }
...
class UserManagement {
    ...
    showErrorAlert(message) {
        Swal.fire({
            ...
            // Stay on current page for error messages
            // User can try the action again
        });
    }
