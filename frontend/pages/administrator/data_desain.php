<?php
/**
 * Administrator - Data Desain Page (Komponen Version)
 * Design management page for administrator role - Menggunakan komponen
 */
        ...
        switch ($_POST['action']) {
            case 'tambah':
                ...
                if ($result['success']) {
                    ...
                    header('Location: data_desain.php?action=added');
                    exit();
                } else {
            ...
            case 'edit':
                ...
                if ($result['success']) {
                    // Use PRG pattern to prevent duplicate submission
                    $_SESSION['success_message'] = $result['message'];
                    header('Location: data_desain.php?action=updated');
                    exit();
                } else {
                    $error_message = $result['message'];
                }
            ...
            case 'hapus':
                ...
                if ($result['success']) {
                    // Use PRG pattern to prevent duplicate submission
                    $_SESSION['success_message'] = $result['message'];
                    header('Location: data_desain.php?action=deleted');
                    exit();
                } else {
                    $error_message = $result['message'];
                }
...
$additional_css = ['assets/css/pages/administrator/data_desain.css'];

// Add JavaScript file for this page
$additional_js = ['assets/js/pages/administrator/data_desain.js'];
